...
Write-Host ' - - - - - - - - - - - - - - - - - - - - - - - - - '
$AzureRepoName = "AzureDeployment"
$ADOCloneURL = "dev.azure.com/orchestrationtesting/AzureDeployment/_git/AzureDeployment"
$GitHubCloneURL = "github.com/NickP365/AzureDeployment"
